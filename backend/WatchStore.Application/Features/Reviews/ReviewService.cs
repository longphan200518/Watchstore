...
namespace WatchStore.Application.Features.Reviews
{
    public class ReviewService : BaseService, IReviewService
    {
        ...
        public ReviewService(IServiceFacade facade)
            : base(facade, facade.GetLogger<ReviewService>())
        {
            _reviewRepository = facade.UnitOfWork.GetRepository<Review>();
            _watchRepository = facade.UnitOfWork.GetRepository<Watch>();
            _userRepository = facade.UnitOfWork.GetRepository<User>();
