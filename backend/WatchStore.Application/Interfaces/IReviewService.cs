...
namespace WatchStore.Application.Interfaces
{
  public interface IReviewService
  {
    ...
    Task<ApiResponse<PagedResponse<ReviewDto>>> GetAllReviewsAsync(ReviewAdminFilterDto filter, PaginationParams pagination);
    Task<ApiResponse<bool>> AdminDeleteReviewAsync(int reviewId);
