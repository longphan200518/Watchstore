...
namespace WatchStore.Infrastructure.Migrations
{
    ...
    [Migration("20260607061611_AddNormalizedCommerceTables")]
    partial class AddNormalizedCommerceTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasIndex("CartId", "WatchId")
                        .IsUnique();

                    b.ToTable("CartItems");
                });

            modelBuilder.Entity("WatchStore.Domain.Entities.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.CouponUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.InventoryTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.PriceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.WebsiteSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.CouponUsage", b =>
                {
                    b.HasOne("WatchStore.Domain.Entities.Coupon", "Coupon")
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.InventoryTransaction", b =>
                {
                    b.HasOne("WatchStore.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WatchStore.Domain.Entities.PriceHistory", b =>
                {
                    b.HasOne("WatchStore.Domain.Entities.User", "ChangedByUser")
                        .WithMany()
