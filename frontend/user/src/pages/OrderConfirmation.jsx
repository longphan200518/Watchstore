      ...
      <main className="max-w-[1000px] mx-auto px-6 lg:px-12 py-12">
        ...
        <div className="flex gap-4 justify-center">
          <button
            ...
            className={`px-8 py-3 rounded-lg font-semibold uppercase tracking-widest transition ${
              isDark
          ...
          <button
            onClick={() => navigate("/products")}
            className={`px-8 py-3 rounded-lg font-semibold uppercase tracking-widest transition border ${
              isDark
