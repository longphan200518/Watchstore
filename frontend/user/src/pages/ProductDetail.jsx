...
export default function ProductDetail() {
  ...
  const handleAddToCart = () => {
    if (quantity > 0 && product.status === "Available") {
      ...
      items: [
        {
          ...
          value: product.movement || "Automatic",
        },
        {
          label: language === "vi" ? "Chức năng" : "Function",
          value: "Chronograph / Date",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          value:
            language === "vi" ? "Thép không gỉ 316L" : "316L Stainless Steel",
        },
        {
          label: language === "vi" ? "Dây" : "Band",
          value: language === "vi" ? "Da / Thép" : "Leather / Steel",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          value: `${product.waterResistance || 10}ATM`,
        },
        {
          label: language === "vi" ? "Bảo hành" : "Warranty",
          value: language === "vi" ? "24 tháng" : "24 months",
        },
      ],
    },
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="lg:pl-8">
                ...
                <div className="flex items-center gap-3 mb-8">
                  ...
                  >
                    (95 {language === "vi" ? "đánh giá" : "reviews"})
                  </span>
                </div>
