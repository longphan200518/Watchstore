...
export default function ResetPassword() {
 ...
 className="w-12 h-14 text-center text-xl font-semibold border-2 border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:border-black focus:ring-2 focus:ring-amber-200"
 />
 ))}
 </div>
 </div>
 ...
 className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
